    ...
    <footer id='footer' className='w-full bg-obsidian-glass-outline flex flex-row items-center px-6 py-4 gap-4'>
      <div className='flex flex-row items-center gap-6'>
        ...
        <nav className='flex gap-6'>
          <a href='#logo' onClick={() => lenis?.scrollTo('#team')} className='text-white text-lg hover:underline'>
            Team
          </a>
          <a
            href='#inhabitants-section'
            onClick={() => lenis?.scrollTo('#inhabitants-section')}
      ...
      <div className='flex flex-row items-center ml-auto gap-6'>
        ...
        <div className='flex gap-4'>
          <a
            className='icon'
            href='https://discord.gg/uEh2pBVU88'
            target='_blank'
          ...
          <a
            className='icon'
            href='https://x.com/catalyst2000251'
            target='_blank'
            rel='noopener noreferrer'
            aria-label='Twitter'
          >
          ...
          <a
            className='icon'
            href='https://github.com/JeremySeq/Inhabitants'
            target='_blank'
            rel='noopener noreferrer'
            aria-label='GitHub'
          >
